...
<?php if(isset($users_fname, $users_lname, $users_email, $users_acctid, $users_pwd)): ?>
        <h1>You must first signup for the service by setting up the following <?=$users_fname, $users_lname, $users_email, $users_acctid, $users_pwd?></h1>
            <?php else: ?>
                        ...
                        <form role="form" action="/users/p_signup" method="post" id="signUpForm" autocomplete="off">
                            <input type="hidden" name="from" value="home">
                                <div class="form-group">
                                    <input type="text" required class="form-control" id="inputFName" placeholder="First Name" name="first_name" tabindex="1">
